export const aboutData = {
  hero: {
    ...
    description:
      "AB2HR was founded on a simple belief: HR teams deserve tools that reduce friction, not create it. We are building an all-in-one platform that brings payroll, attendance, hiring, and employee experience under one roof.",
  },
  ...
  story: {
    ...
    paragraphs: [
      "AB2HR was born out of a common frustration. Our founders saw HR teams drowning in spreadsheets, chasing approvals over WhatsApp, and manually reconciling payroll every month. The tools they had were either too expensive, too complex, or too generic.",
      ...
      "Today, AB2HR serves teams across industries, helping them manage the entire employee lifecycle from hiring to offboarding. We are a small, focused team with a big ambition: to become the HR backbone for every growing business.",
    ],
  },
  ...
  team: {
    ...
    members: [
      ...
      },
      {
        ...
        bio: "Product manager who spent years embedded with HR teams in fast-growing startups before joining AB2HR.",
        initials: "RS",
      },
      {
        name: "Sunita Verma",
  ...
  cta: {
    ...
    description:
      "Join growing teams who have simplified their HR workflows with AB2HR. Start your free trial today — no credit card required.",
